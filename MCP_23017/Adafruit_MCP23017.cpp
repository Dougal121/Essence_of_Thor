...
uint8_t Adafruit_MCP23017::getaddress(){
	return i2caddr;
}
/**
...
void Adafruit_MCP23017::pulsepin(const uint8_t pin, const uint8_t p_delay, const uint8_t polarity){
	uint8_t gpio;
	uint8_t bit=bitForPin(pin);
