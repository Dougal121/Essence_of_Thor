...
{
public:
    PCF8574(const uint8_t deviceAddress=0x20);
    PCF8574();
	...
	void setaddress(const uint8_t deviceAddress);
	uint8_t getaddress();
    ...
    void pulsepin(const uint8_t pin, const uint8_t p_delay, const uint8_t polarity);
