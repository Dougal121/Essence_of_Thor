...
/*          if ((evalve[i].OnOffPolPulse & 0x08) != 0 ){
          ...
          message += "<form method=post action=" + server.uri() + "><td><input type='text' name='ncom"+MyNum+"' value='" + String(evalve[i].Valve & 0x7f) + "' maxlength=3 size=2></td>";
          ...
          message += "<input type='hidden' name='command' value='4'><td><input type='text' name='vfbt"+MyNum+"' value='" + String(evalve[i].FeedbackBoardBit & 0x0f ) + "' maxlength=3 size=2></td><td><input type='text' name='vfad"+MyNum+"' value='" + String((evalve[i].FeedbackBoardBit & 0xf0 ) >> 4 ) + "' maxlength=3 size=2></td>" ;
